...
export class AuthService {
  ...
  register(username:string, nomeEnte: string, name: string,  surname: string,
    email: string,
    password: string,
    tipoUser: string): Observable<any> {
      const newUser = { email, password, name, surname, tipoUser, username};
